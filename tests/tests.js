...
export function runAllTests() {
  ...
  return {
    results: [...p2.results, ...p3.results, ...p4.results, ...p5.results],
    passed:  p2.passed + p3.passed + p4.passed + p5.passed,
    failed:  p2.failed + p3.failed + p4.failed + p5.failed,
    total:   p2.total  + p3.total  + p4.total  + p5.total,
  };
}
